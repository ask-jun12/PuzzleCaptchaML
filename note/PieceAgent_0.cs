...
public class PieceAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        else if ((this.sTime < this.timeAcc) && (this.timeAcc <= this.mTime)) // 送筆
        {
            ...
            AddReward((previousDistance - nowDistance) * 10.0f);
            // 送筆の速度が（平均 ± 標準偏差）に近いほど得点
            AddReward(1.0f / (4.0f + Mathf.Abs(velocity-this.gVel)));
        }
        ...
        //     AddReward(10.0f);
        //     // 送筆の時間に近ければさらに得点
        //     // if (Mathf.Abs(this.timeAcc-this.mTime) < 0.01f)
        //     // {AddReward(5.0f);}
        //     // 終筆の時間に近ければ得点・終了
        //     // if (Mathf.Abs(this.timeAcc-this.gTime) < 0.1f)
        //     // {AddReward(20.0f);}
        //     // 全体時間が（平均 ± 標準偏差）に近いほど得点
        //     // if ((2.555f < this.timeAcc) && (this.timeAcc < 3.039f))
        //     // {AddReward(5.0f);}
        //     AddReward(5.0f / (1.0f + Mathf.Abs(this.timeAcc-this.gTime)));
        //     Debug.LogError("success");
        //     EpisodeReset();
        //     EndEpisode();
        // }
        ...
        // s経過すると減点・強制終了
        // if (this.timeAcc > (this.gTime + 3.0f))
        // {
        //     AddReward(-3.0f);
        //     Debug.LogWarning("miss");
        //     EpisodeReset();
